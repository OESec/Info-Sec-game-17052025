      ...
      {isAnalyzing ? (
        ...
        <Card className="border-emerald-200 dark:border-emerald-900">
          ...
          <CardContent className="space-y-6">
            ...
            {/* Vibe-Coded AI disclaimer at bottom of analysis results */}
            <div className="mt-6 pt-4 border-t border-muted">
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <img src="/images/vibe-coded-icon.png" alt="Vibe-Coded" className="h-4 w-4" />
                <span className="font-medium">Vibe-Coded Analysis:</span>
                <span>Generated by AI. Always verify security recommendations with authoritative sources.</span>
              </div>
            </div>
          </CardContent>
          <CardFooter>
